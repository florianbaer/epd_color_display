...
export async function getGalleryFeed(limit: number = 10, offset: number = 0): Promise<FeedResponse> {
  return fetchJson<FeedResponse>(`/gallery/feed?limit=${limit}&offset=${offset}`)
}
